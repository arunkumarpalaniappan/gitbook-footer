			...
			const htmlContents = ' \n\n<footer class="footer">' +
				'<div class="footer__container--' + defaultOption.style + '" alt="' + uri + '">' +
					...
					'<div class="footer__description--' + defaultOption.style + '">' +
						'<p class="paragraph footer__author--' + defaultOption.style + '" style="color: #636262 !important;">' + defaultOption.signature  +
						'<p class="paragraph footer__quote--' + defaultOption.style + '" style="color: #636262 !important;">' + defaultOption.wisdom + '</p>' +
	...
	test: function (configs) {
		...
		const htmlContents = ' \n\n<footer class="footer">' +
			'<div class="footer__container--' + defaultOption.style + '" alt="' + uri + '">' +
				qrImg +
				'<div class="footer__description--' + defaultOption.style + '">' +
					'<p class="paragraph footer__author--' + defaultOption.style + '" style="color: #000 !important;">' + defaultOption.signature + 
